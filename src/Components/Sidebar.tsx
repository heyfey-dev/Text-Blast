...
export function Sidebar({ isOpen, onCloseMobile }: SidebarProps) {
  ...
  const menuItems = [
    ...
    { id: "send-sms", label: "Send SMS", icon: Send, path: "/send-sms" },
    { id: "sms-history", label: "SMS History", icon: History, path: "/sms-history" },
    { id: "buy-credits", label: "Buy Credits", icon: CreditCard, path: "/buy-credits" },
